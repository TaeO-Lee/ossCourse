...
class Main(QDialog):
    ...
    def init_ui(self):
        ...
        layout_first_floor = QHBoxLayout()
        layout_number = QGridLayout()
        layout_equation_solution = QFormLayout()
        layout_second_floor = QHBoxLayout()
        ...
        # =, ce, c, backspace 버튼을 layout_first_floor 레이아웃에 추가
        layout_first_floor.addWidget(button_modula)
        layout_first_floor.addWidget(button_CE)
        layout_first_floor.addWidget(button_C)
        ...
        # %, 1/x, x^2, 제곱근 버튼을 layout_second_floor 레이아웃에 추가
        layout_second_floor.addWidget(button_reciprocal)
        layout_second_floor.addWidget(button_multiple)
        layout_second_floor.addWidget(button_root)
        layout_second_floor.addWidget(button_division)
        ...
        main_layout.addLayout(layout_first_floor)
        main_layout.addLayout(layout_second_floor)
